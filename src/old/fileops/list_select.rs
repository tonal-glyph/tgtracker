...
mod feature {
    ...
    pub fn main() {
        ...
        // Build the window.
        let mut events_loop = nannou::glium::glutin::EventsLoop::new();
        let window = nannou::glium::glutin::WindowBuilder::new()
            .with_title("ListSelect Demo")
            .with_dimensions((WIDTH, HEIGHT).into());
        let context = nannou::glium::glutin::ContextBuilder::new()
            .with_vsync(true)
            .with_multisampling(4);
        let display = nannou::glium::Display::new(window, context, &events_loop).unwrap();
        // Construct our `Ui`.
        ...
        // for drawing to the nannou::glium `Surface`.
        ...
        'main: loop {
            ...
            for event in event_loop.next(&mut events_loop) {
                ...
                match event {
                    nannou::glium::glutin::Event::WindowEvent { event, .. } => match event {
                        // Break from the loop upon `Escape`.
                        nannou::glium::glutin::WindowEvent::CloseRequested |
                        nannou::glium::glutin::WindowEvent::KeyboardInput {
                            input: nannou::glium::glutin::KeyboardInput {
